...
class reader_FBX : public f3d::reader
{
public:
  reader_FBX()
  {
   ...
   */
  const std::string getName() const override { return "FBX"; }

  /*
   * Get the short description of this reader
   */
  const std::string getShortDescription() const override { return "Filmbox"; }
  ...
  {
    static const std::vector<std::string> types = { "application/vnd.fbx" };
    return types;
  }
